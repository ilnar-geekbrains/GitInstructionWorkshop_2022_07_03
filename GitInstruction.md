...
* Это некий репозиторий (Локальный или удалённый) с помощью которого можно контролировать версии продукта, вносить изминения в него...
...
* Доя тоого чтобы создать ветку нужно ввсети команду git branch NewBranchName или git cheackout -b Name_New_Branch для создания и одновременного перехода на созданую ветку 
...
* Удалённый репозиторий (Push) на GitHub, он нужен для того чтобы могли работать несколько людей
...
* Строится на удалённых репозиториях. Нужна для большийх проектов, для работы в команде
