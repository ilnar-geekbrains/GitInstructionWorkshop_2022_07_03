...
Для работы с ветками необхдимо использовать следующие команды:

1. git branch - просмотр всех созданных веток
2. git branch имя ветки - создание ветки
3. git branch -d имя ветки - удаление ветки
4. git merge имя ветки - стоя в ветке master вводим указанную команду, далее происходит перенос ветки в ветку master
