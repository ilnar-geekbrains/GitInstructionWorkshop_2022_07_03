...
**Система контроля версий нужна для хранения различных версий кода, а также для более удобного перемещения между ними**

### Что такое система контроля версий?

*это сиситема, записывающая изменения в файл в течение времени и позволяющая вернуться к определенной версии*

### Для чего нужна система контроля версий

_Для хранения различных версий и перемещения между ними_
...
__Репозиторий есть хранилище файлов, которые находятся во власти системы контроля версий__
...
* Это версия проекта, которая лежит на удаленном сервере. Такое устройство хранения данных облегчает работу над проектом в случае большого числа разработчиков.
