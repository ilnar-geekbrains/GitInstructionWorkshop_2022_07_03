...
2. C помощью команды git clone плюс скопированный хэш код репозитория добавьте этот репозиторий в новую папку в Visual studio.

3. Создайте изменения в проекте в отдельно созданной ветке.

4. C помощью команды git push отправьте проект с внесенными Вами изменениями на Ваш аккаунт на GitHub.

5. Обновите свой аккаунт.

6. Нажав кнопку pull request отправьте запрос на вливание.

7. Добавьте свой комментарий. 
