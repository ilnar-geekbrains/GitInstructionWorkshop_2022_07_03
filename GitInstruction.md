...
6. После сохранений командой git push отправляем изменения в удаленный репозиторий. Гит может предложить дополнить команду ссылкой, кпируем предложенный вариант и используем его.
