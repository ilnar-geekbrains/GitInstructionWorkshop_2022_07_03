...
Удаленный репозиторий-это версии проекта, сохраненные на удаленном сервере.  Цель удаленного репозитория  - опубликовать ваш код и позволить другим людям читать или писать его. 
