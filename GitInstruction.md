...
Система контроля версия- это система, записывающая изменения в файл или набор файлов в течение времени и позволяющая вернуться позже к определенной версии. Позволяет оптимизировать процесс и сэкономить память. Необходима программистам и тестировщикам
