...
__Система контроля необходима для отслеживания изменений в программе/файле и т.д., а так же помогает для коллективной работы над одной программой/файлом. Отслеживать версии файлов/программы.__
