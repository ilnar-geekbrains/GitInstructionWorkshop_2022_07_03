...
Контроль версий нужен для хранения различных версий какого-либо проекта(сайта, программы, книги) и для возможности откатиться до предыдущей версии. Например, если новая версия программы работает криво, можно, при помощи контроля версий откатиться до рабочей. Хороший пример контроля версий - сохранения в играх.
