...
Контроль версий (контроль исходного кода) - практика, позволяющая отслеживать изменения исходного кода и управление ими. Он хранит различные версии проекта и позволяет возвращаться к разным версиям проекта.
### Что такое система контроля версий?

**Система контроля** - реализованная возможность замены информации с использованием сохраненных версий. Контроль версий удобен тем, что имеется возможность работать вместе над одним репозиторием, тем самым помогает синхронизировать усилия.

Для удобства работы имееется популярное приложение контроля версий Visual Studio Code

![vsc](vsc.png)

**Git** - система контроля версий.
Позволяет освоить работу с удаленными репозиториями, которые находятся не локальной, а на удаленном компе (на сервере). Организация + поддержание версионности

![git](git.jpg)

### Для чего нужна система контроля версий

Очень удобно работать с ветками, можно создать одну ветку, которая будет являться чистовиком, а вот уже последующие ветки будут в виде черновиков, в таком случае, можно переключаться с ветку на ветку, делая различные изменения, дополнять информация. Позже можно сливать информация с черновой версии ветки в чистовой.
