...
Это нужно для того, несколько разработчиков могли одновременно вносить изменения в различных версиях, не нарушая работу существующей версии.
* Изменил в новой ветке
