...
# Система контроля версий - это система которая помогает создавать/сохранять резервные копии материала работающей версиина данный момент, с целью улучшить ее или мадернизировать-создать новую версию.
